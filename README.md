...
- Rudraksh Kuchiya (20D110021): Formulating the model, writing the python notebook, analysing data, fitting the model and generating results; compiling the github repo and readme file.
